...
<footer class="container max-w-4xl pt-16">
  <div class="mb-16 flex flex-col gap-12 sm:flex-row sm:justify-between sm:gap-24">
    ...
    <div class="flex flex-col gap-12 sm:flex-row sm:gap-24">
      <div class="flex flex-col gap-4">
        <h3 class="text-base">VaultZen</h3>
        <ul class="flex flex-col gap-2 text-sm text-muted-foreground">
          <li>
            <a href="mailto:zaymorielvandrell@gmail.com">Contact</a>
          </li>
          <li>
      ...
      <div class="flex flex-col gap-4">
        <h3 class="text-base">Download</h3>
        <ul class="flex flex-col gap-2 text-sm text-muted-foreground">
          <li>Chrome</li>
          <li>Edge</li>
          <li>Firefox</li>
  ...
  <div
    class="not-typography flex flex-col items-center gap-4 border-t py-4 text-sm text-muted-foreground sm:flex-row sm:justify-between">
    <p>&copy; {new Date().getFullYear()} VaultZen. All rights reserved.</p>
